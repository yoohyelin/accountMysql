...
class AccountControllerTest {
        ...
        List<AccountDto> accountDtos =
                Arrays.asList(
                        ...
                        AccountDto.builder()
                                ...
                                .balance(3000L).build() // 생성하는거 함수로 빼서 해도됨
                );
    ...
    // then
        mockMvc.perform(get("/account?user_id=1"))
                ...
                .andExpect(jsonPath("$[0].balance").value(1000))// $ 루트
             .andExpect(jsonPath("$[1].accountNumber").value("1111111111"))
                .andExpect(jsonPath("$[1].balance").value(2000))// $ 루트
             .andExpect(jsonPath("$[2].accountNumber").value("2222222222"))
                .andExpect(jsonPath("$[2].balance").value(3000)); // $ 루트
    }
